...
contextBridge.exposeInMainWorld('iptvAPI', {
    ...
    scheduleRecording: (channelUrl, channelName, programName, startTime, endTime, headers, force) => ipcRenderer.invoke('schedule-recording', channelUrl, channelName, programName, startTime, endTime, headers, force),
