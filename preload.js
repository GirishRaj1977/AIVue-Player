...
contextBridge.exposeInMainWorld('iptvAPI', {
    ...
    getEpgLogos: (epgSources) => ipcRenderer.invoke('get-epg-logos', epgSources),
    ...
    scheduleRecording: (channelUrl, channelName, programName, startTime, endTime, headers, force, description) => ipcRenderer.invoke('schedule-recording', channelUrl, channelName, programName, startTime, endTime, headers, force, description),
    ...
    addSeriesRule: (channelTitle, titlePattern) => ipcRenderer.invoke('add-series-rule', channelTitle, titlePattern),
    getSeriesRules: () => ipcRenderer.invoke('get-series-rules'),
    deleteSeriesRule: (ruleId) => ipcRenderer.invoke('delete-series-rule', ruleId),
    triggerSeriesScan: () => ipcRenderer.invoke('trigger-series-scan'),
    onOpenDvrPage: (callback) => ipcRenderer.on('open-dvr-page', callback),
