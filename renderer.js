...
function renderChannels() {
    ...
    flattenedItems.forEach(item => {
        if (item.type === 'group') {
            ...
            const eqHtml = window.isPlayingChannel && isPlayingChannel(channel, index) ? getMiniEqualizerHtml() : '';
    ...
    if (window.updatePlayingChannelIndicator) updatePlayingChannelIndicator();
}
